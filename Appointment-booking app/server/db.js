 ...
 *
 * When VITEST or MOCK_DB is set, swaps to an in-memory mock so tests run
 * without a real PostgreSQL instance (useful for dev without Docker).
 *
 ...
 *   MOCK_DB       — When truthy, uses in-memory tables (same as VITEST)
 */
